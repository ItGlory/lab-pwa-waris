...
const createMarkerIcon = (severity: string): L.DivIcon => {
...
// Pre-create icons for each severity
...
export function AlertMapImpl({
  ...
  const center: L.LatLngExpression = [13.2, 101.0]; // Center of Thailand
